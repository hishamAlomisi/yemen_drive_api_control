...
namespace YemenDrive.Database.Migrations
{
    ...
    [Migration("20260919195407_AddCustomerCashPaymentConfirmation")]
    partial class AddCustomerCashPaymentConfirmation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YemenDrive.Database.Entities.CashPaymentRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CashPaymentRequests", t =>
                        {
                            t.HasCheckConstraint("CK_CashPaymentRequests_Amount_Positive", "[Amount] > 0");
                        });
                });
            ...
            modelBuilder.Entity("YemenDrive.Database.Entities.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsAvailableForRidePayment")
                        .HasColumnType("bit");

                    b.Property<bool>("IsAvailableForWalletTopUp")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("PublicInstructionsAr")
                        .HasMaxLength(2000)
